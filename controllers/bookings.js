...
exports.getBookingInfo = async (req, res, next) => {
  ...
  req._oracledb.execute(
    `SELECT BUILDING_NAME, B_LAT, B_LONG, FLOOR, CAPACITY, PARKING, CATERING, ACCESSIBILITY, TOILET_ID, DURATION, USERNAME, BOOKING_ID
    FROM BOOKINGS_TB,
         ROOM_TB,
         BUILDING_TB,
         USERS_TB
    ...
    AND USERS_TB.USER_ID = BOOKINGS_TB.USER_ID
